...
Status: implemented in PR #101 on `codex/catalogue-defaults-20260914`; **not live**. This extends issue #48 and incorporates the merged PR #102 gallery startup fix, PR #103 first-render/reset correction and PR #104 native task/movement correction. The existing 15 qualified product releases and PR #100 related-card previews are live. Further lossless-image activation, the new defaults, native editor and metadata migration require their own release evidence; see `LOSSLESS-DELIVERY.md` for the current canary and gallery-release checkpoint.
