...
- The original production CSS passed desktop, 390px layout, press/release, keyboard focus, and reduced motion/transparency/forced-colors checks. Live QA exposed the stale visibility flag in the original pointer script; follow-up deployment status remains in issue #13.
