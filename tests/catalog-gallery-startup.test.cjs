...
async function fixture({patched = true, ajax = false, custom = false, defaults = false, offGallery = false, integrated = false, productId = 117, nativeFlexy = false, holdNativeFrame = false, initialItem = null} = {}) {
